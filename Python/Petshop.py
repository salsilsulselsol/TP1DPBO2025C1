class Petshop:
    def __init__(self, id=0, nama="", kategori="", harga=0, stok=0):
        # Constructor untuk kelas Petshop, sekaligus menginisialisasi atribut dan list kosong untuk menyimpan data produk
        self.id = id
        self.nama = nama
    ...
    def set_kategori(self, kategori): self.kategori = kategori
    ...
    def set_stok(self, stok): self.stok = stok

    # Method-method yang dibutuhkan untuk CRUD
    ...
    def create(self):
        ...
        # Cek apakah ID sudah ada pada list
